...
export interface ICacheStoreAPI extends Omit<StoreAPI, 'set'> {
  set(key: any, data: any, expires?: number): any;
}
...
export class CacheService {
  ...
  constructor() {
    this.addCachingFunctionality((store as any)._);
  }

  getCache(): ICacheStoreAPI {
    return store as unknown as ICacheStoreAPI;
  }

  addCachingFunctionality(_) {
    var prefix = 'exp@',
      suffix = ';',
      parse = _.parse,
      _get = _.get,
